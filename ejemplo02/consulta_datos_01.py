...
# Hacer un recorrido por la lista paa obtener nombre y apellido de los estudiantes
# relacionandolos y/o obteniendo los datos a traves de matriculas

for m in matriculas:
	print(f"{m.estudiante.nombre} - {m.estudiante.apellido}")
	#print(f"{m.estudiante}")
